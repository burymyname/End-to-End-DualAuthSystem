package org.nuaa.speakerverification.dataTrans.Receiver;

import android.os.AsyncTask;
import android.os.Process;
import android.util.Log;

import org.nuaa.speakerverification.dataTrans.BitFrequencyConverter;
import org.nuaa.speakerverification.dataTrans.ByteArrayParser;
import org.nuaa.speakerverification.dataTrans.CallbackSendRec;
import org.nuaa.speakerverification.dataTrans.FFT.Complex;
import org.nuaa.speakerverification.dataTrans.FFT.FFT;
import org.nuaa.speakerverification.dataTrans.ReedSolomon.EncoderDecoder;
...
public class RecordTask extends AsyncTask<Integer, Void, Void> implements Callback {
    ...
    protected Void doInBackground(Integer... integers) {
        ...
        int ErrorCheck=integers[3];
        int ErrorCheckByteNum=integers[4];
